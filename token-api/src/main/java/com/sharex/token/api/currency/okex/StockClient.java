...
public class StockClient {
	...
	public static void main(String[] args) throws IOException, NoSuchAlgorithmException {
	    ...
	    String api_key = "90bacbb3-bad4-45fc-a4b4-c9e859f97718";  //OKCoin申请的apiKey
		String secret_key = "0C459ED2589DB5A00A4E26E3645716DA";  //OKCoin 申请的secret_key
	     ...
	     * 
	    */
	    IStockRestApi stockGet = new StockRestApi(api_key, secret_key);
	     ...
	     * 
	    */
	    IStockRestApi stockPost = new StockRestApi(api_key, secret_key);
